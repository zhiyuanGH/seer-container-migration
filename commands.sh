...
docker run --name cnn -v /srv/nfs/share:/data 192.168.1.102:5000/mnist-rnn-image:org python3 -u main.py --batch-size 64 --test-batch-size 1000 --epochs 3 --lr 0.1 --gamma 0.7 --log-interval 1 --save-model
